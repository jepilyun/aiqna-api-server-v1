...
/**
 * generateVectorMetadataInstagramPost
 * TSqlInstagramPostDetail을 TPineconeVectorMetadataForContent으로 변환
 * @param instagramPost TSqlInstagramPostDetail
 * @returns
 */
export function generateVectorMetadataInstagramPost(
  instagramPost: TSqlInstagramPostDetail,
): Partial<IPineconeVectorMetadataForInstagramPost> {
  return {
    instagram_post_url: instagramPost.instagram_post_url, // Instagram 게시물 URL
    local_image_url: instagramPost.local_image_url ?? undefined, // Instagram 로컬 이미지 URL
    ...
    published_date: instagramPost.published_date ?? undefined, // Instagram 게시 날짜 (ISO 8601 형식)
  };
}
